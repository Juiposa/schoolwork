...
public class ConfigWindow extends JFrame implements ActionListener {
	...
	private ButtonGroup parserButtonGroup;
	...
	public ConfigWindow( ActionListener listener ) {
		...
		//selected parser
		JPanel parserButtonPanel = new JPanel();
		parserButtonPanel.setLayout( new FlowLayout( FlowLayout.LEFT, 10, 10));
		JLabel parserButtonLabel = new JLabel("Parser selection: ");
		JRadioButton yadcButton = new JRadioButton("yadc");
		yadcButton.addActionListener(listener);
		yadcButton.setSelected(true);
		JRadioButton ideButton = new JRadioButton("Dialogc");
		ideButton.addActionListener(listener);
		parserButtonGroup = new ButtonGroup();
		parserButtonGroup.add(yadcButton);
		parserButtonGroup.add(ideButton);
		parserButtonPanel.add(parserButtonLabel);
		parserButtonPanel.add(yadcButton);
		parserButtonPanel.add(ideButton);
		//end; select parser
