...
public class test4FieldEdit extends JFrame implements ActionListener {
	...
	public test4FieldEdit() {
		...
		DefaultButton.addActionListener(new test4Default(this));
		//end DefaultButton
	...
	public static void main( String[] args ) {
		test4FieldEdit runWindow = new test4FieldEdit();
