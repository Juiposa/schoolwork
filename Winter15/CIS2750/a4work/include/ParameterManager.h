...
/* PL_reset
 * dual purpose, reset list so we can pass through it again, and counts the number of items
 * Parameters: 	l - list to be reset/coutned
 * Returns: number of items in the list
*/
int PL_reset( ParameterList * l );
...
/* emitJava
 * lots a loops and stuff for outputting pretty much the same file no matter what the .config looks like
 * Parameters: 	tfb - pm of the buttons and field name
 *				types - button actinListeners and field data types
 *				fieldCount - number of fields
 *				buttonCount - nuber of buttons
 *				Cpn - project name, for naming directory and .java file
 * Returns: nothing
*/
